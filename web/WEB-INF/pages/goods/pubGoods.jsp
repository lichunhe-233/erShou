    ...
    <div id="user_area">
        ...
        <div id="user_nav">
            <div class="user_info">
              ...
              <!--   <span class="school">校园二手物品交易网站</span> -->
                ...
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="changeinfo">
                        ...
                        <select class="in_info" name="catelogId">
                            <option value="1">数码刊物</option>
                            <option value="2">体育杂志</option>
                            <option value="3">工具书</option>
                            <option value="4">畅销图书</option>
                            <option value="5">时尚杂志</option>
                            <option value="6">篮球传记</option>
                            <option value="7">金融刊物</option>
                        </select>
                    </div>
